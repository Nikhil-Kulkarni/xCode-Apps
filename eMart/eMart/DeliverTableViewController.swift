//
//  DeliverTableViewController.swift
//  eMart
//
...
class DeliverTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        var dataArray: [FDataSnapshot] = []
        fb.queryOrderedByKey().observeEventType(.ChildAdded, withBlock: { (snapshot) -> Void in
            dataArray.append(snapshot)
            println(dataArray[0].description)
        })
        return 10
    }
